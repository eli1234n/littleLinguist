...
let animalsCategory = 
    new Category('', "Animals", Language.English, Language.Hebrew);
...
let peopleCategory =
    new Category('', "People", Language.English, Language.Hebrew);
...
let placesCategory = 
    new Category('', "Places", Language.English, Language.Hebrew);
